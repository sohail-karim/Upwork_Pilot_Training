...
public class GridManagerPro : MonoBehaviour
{
    ...
    public GameObject[,] gridCells = new GameObject[4, 4];
    ...
    [HideInInspector]
    public bool[,] cellFilled = new bool[4, 4]; // Track the filled state of each cell
    [HideInInspector]
    public Sprite[,] solutionGrid = new Sprite[4, 4]; // Solution grid for backtracking
    ...
    public static GridManagerPro instance;
    ...
    void GenerateSolutionGrid()
    {
        ...
        questionMarkPosition = new Vector2Int(Random.Range(0, 4), Random.Range(0, 4));
    ...
    void AssignClues()
    {
        int cluesToPlace = Random.Range(5, 7);
